  ...
  return (
    <>
      <Card className="sticky top-24">
        ...
        <CardFooter>
          <SubmitButton imageSelected={!!imagePreview} isPending={isModelPending} text={isModelPending ? "Generating..." : "Generate Model"}/>
        </CardFooter>
      </Card>
            ...
            <div className="relative flex items-center justify-center rounded-md border bg-secondary/50">
                ...
                {hasCameraPermission === false && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-background/80 p-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Please enable camera permissions in your browser settings to use this feature.</p>
                    </div>
                )}
